...
nohup $crux lfq $percolator $spectrum_files_folder/*$extension --output-dir $output_dir --spectrum-parser mstoolkit --mods-spec 1M+15.9949 --nterm-peptide-mods-spec 1X+42.010565  --psm-file-format percolator > nohup_crux-lfq.txt &
