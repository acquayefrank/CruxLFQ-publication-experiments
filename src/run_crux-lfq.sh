...
output_dir="${results_folder}/${timestamp}_crux_lfq-output"
...
nohup $crux lfq $percolator $spectrum_files_folder/*$extension --specfile-replicates $resplicate_file --output-dir $output_dir --spectrum-parser mstoolkit --mods-spec 1M+15.9949 --nterm-peptide-mods-spec 1X+42.010565  --psm-file-format percolator --normalize true  > nohup_crux-lfq.txt &
